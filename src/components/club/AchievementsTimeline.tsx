...
const competitors2026: CompetitorData[] = [
  ...
  },
  {
    ...
    cover: davidPodium,
    bio: [
      'Давид Цаневски е един от младите състезатели на „Берое Армрестлинг", който се изкачва уверено по подиумите на националната сцена. На Републиканското първенство по канадска борба 2026 г. в Панагюрище той се качи на второто стъпало и с двете ръце — два сребърни медала в категория 65+ кг, извоювани с характер и техника.',
    ...
    gallery: [
      { src: davidPodium, alt: "Давид Цаневски на подиума — Републиканско първенство 2026" },
      { src: davidMatch1, alt: "Давид Цаневски в схватка на масата — Републиканско първенство 2026" },
      { src: davidMatch2, alt: "Давид Цаневски срещу съперник — Републиканско първенство 2026" },
    ],
  },
  {
  ...
  },
  {
    ...
    cover: milkyPodium,
    bio: [
      'Николай Малаков, познат на всички в залата като Milky, е един от най-ярките млади таланти на „Берое Армрестлинг". На Републиканското първенство по канадска борба 2026 г. в Панагюрище той се качи на най-високото стъпало на подиума и с двете ръце — два златни медала в категория 65+ кг.',
    ...
    gallery: [
      { src: milkyPodium, alt: "Николай Малаков на първото стъпало на подиума — Републиканско първенство 2026" },
      { src: milkyMatch1, alt: "Николай Малаков в схватка на масата — Републиканско първенство 2026" },
      { src: milkyMatch2, alt: "Николай Малаков срещу съперник — Републиканско първенство 2026" },
    ],
  },
  {
    name: "Георги Чолаков",
...
const achievements = [
  {
    year: "Световно",
    icon: Globe,
    title: "Световно първенство — победи за Щерьо Щерев и Маламир Михалев",
    text: 'Първите големи крачки на „Берое Армрестлинг" на световна сцена — Щерьо Щерев надви елитен международен съперник в категория 80 кг, а Маламир Михалев се наложи над казахстански състезател в категория 70+ кг (юноши до 15 г.).',
    highlight: true,
